...
function AdminResults() {
  return (
    <div className="space-y-8 p-6 max-w-7xl mx-auto">
      <h1 className="text-3xl font-bold text-center text-gray-800 mb-8">Results Management</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-medium text-gray-800">Add Result Record</h3>
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-medium text-gray-800">Delete Result Record</h3>
              <p className="text-sm text-gray-500 mt-1">Remove existing result</p>
            </div>
          </div>
        </Link>
      </div>
