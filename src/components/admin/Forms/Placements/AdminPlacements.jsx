...
function AdminPlacements() {
  return (
    <div className="space-y-8 p-6">
      <h1 className="text-center text-3xl font-bold text-gray-800 mb-8">Placements Operations</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-medium text-gray-800">Add Placement Record</h3>
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-medium text-gray-800">Delete Placement Record</h3>
              <p className="text-sm text-gray-500 mt-1">Remove existing placement entry</p>
            </div>
          </div>
        </Link>
      </div>
