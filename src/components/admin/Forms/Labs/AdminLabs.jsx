...
function AdminLabs() {
  return (
    <div className="space-y-8 p-6">
      <h1 className="text-center text-3xl font-bold text-gray-800 mb-8">Labs Operations</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-medium text-gray-800">Add Lab</h3>
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-medium text-gray-800">Update Lab</h3>
