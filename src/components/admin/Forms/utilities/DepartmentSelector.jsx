...
function departmentSelector({ name, setValue }) {
  ...
  return (
    <select name={name} onChange={(event) => setValue(event.currentTarget.value)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5">
