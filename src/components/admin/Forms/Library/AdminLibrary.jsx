...
function AdminLibrary() {
  return (
    <div className="space-y-8 p-6">
      <h1 className="text-center text-3xl font-bold text-gray-800 mb-8">Library Operations</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-medium text-gray-800">Add Book</h3>
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-medium text-gray-800">Delete Book</h3>
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-medium text-gray-800">Update Book</h3>
              <p className="text-sm text-gray-500 mt-1">Modify lab details</p>
            </div>
          </div>
        </Link>
      </div>
