...
const ResultRecord = ({ result, index }) => {
    return (
        <>
            ...
            <tr className={`md:hidden ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'} hover:bg-red-50`}>
                <td className="px-4 py-3 border-b border-gray-200" colSpan="6">
                    <div className="flex flex-col space-y-2">
                        <div className="flex justify-between items-start">
                            <div>
                                <h3 className="font-medium text-gray-900">{result.name}</h3>
                                <p className="text-sm text-gray-500">{result.pin}</p>
                            </div>
                        ...
                        <div className="pt-1">
                            <p className="text-sm text-gray-700">App ID: {result.application_id}</p>
                        </div>

                        <div className="flex justify-between items-center pt-1">
                            <span className="font-semibold text-green-600">{result.percentage}%</span>
